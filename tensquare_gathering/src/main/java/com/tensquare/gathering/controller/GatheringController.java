...
public class GatheringController {
	...
	public Result findAll(){
		return new Result(true,StatusCode.OK.getCode(),"查询成功",gatheringService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,StatusCode.OK.getCode(),"查询成功",gatheringService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(true,StatusCode.OK.getCode(),"查询成功",  new PageResult<Gathering>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,StatusCode.OK.getCode(),"查询成功",gatheringService.findSearch(searchMap));
    }
